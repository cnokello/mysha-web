...
public class User implements Serializable {
  ...
  public String toEventString() {
    return id + "|" + (surname == null ? "" : surname) + "|"
        + (otherNames == null ? "" : otherNames) + "|" + (username == null ? "" : username) + "|"
        + (password == null ? "" : password) + "|" + (password1 == null ? "" : password1) + "|"
        + (email == null ? "" : email) + "|" + (mobile == null ? "" : mobile) + "|"
        + (imei == null ? "" : imei) + "|" + (socialNetworkToken == null ? "" : socialNetworkToken)
        + "|" + (socialNetworkSecret == null ? "" : socialNetworkSecret) + "|"
